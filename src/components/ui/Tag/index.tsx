...
export const Tag: FC<TagProps> = ({
  ...
  const colorVariants = {
    primary: {
      ...
      outline:
        "bg-white dark:bg-gray-800 text-primary-600 dark:text-primary-400 ring-1 ring-inset ring-primary-300 dark:ring-primary-700",
    },
    secondary: {
    ...
    accent: {
      ...
      outline:
        "bg-white dark:bg-gray-800 text-accent-600 dark:text-accent-400 ring-1 ring-inset ring-accent-300 dark:ring-accent-700",
    },
    success: {
      ...
      outline:
        "bg-white dark:bg-gray-800 text-success-600 dark:text-success-400 ring-1 ring-inset ring-success-300 dark:ring-success-700",
    },
    warning: {
      ...
      outline:
        "bg-white dark:bg-gray-800 text-warning-700 dark:text-warning-400 ring-1 ring-inset ring-warning-300 dark:ring-warning-700",
    },
    error: {
      ...
      outline:
        "bg-white dark:bg-gray-800 text-error-600 dark:text-error-400 ring-1 ring-inset ring-error-300 dark:ring-error-700",
    },
    gray: {
      ...
      outline:
        "bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-400 ring-1 ring-inset ring-gray-300 dark:ring-gray-600",
    },
  };
