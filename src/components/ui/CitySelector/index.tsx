      ...
      <div className="flex flex-col h-full bg-white">
        ...
        <div className="flex-shrink-0 px-4 pt-4 pb-3 border-b border-gray-100">
          ...
          <div className="relative">
            <div className="flex items-center h-10 bg-slate-100 rounded-full px-4 gap-2">
              ...
              <IndexBar className="city-index-bar h-full" sticky={false}>
                ...
                {cityGroups.map((group) => (
                  <IndexBar.Panel
                    index={group.title}
                    title={
                      <div className="px-4 py-2 bg-slate-50 text-xs font-semibold text-gray-500 sticky top-0">
                        {group.title}
                      </div>
                    }
                    key={group.title}
